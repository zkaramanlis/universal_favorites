...
class ButtonRow extends React.Component {
    render() {
        return(
            <div id="buttonRow">
                <button onClick={this.goBack} disabled={this.props.backDisabled} id="backButton" className="menuButton">
                ...
                <button onClick={this.add} disabled={this.props.addDisabled} className="menuButton">
                ...
                <button onClick={this.settings} disabled={this.props.settingsDisabled} className="menuButton">
                    {this.props.settingsDisabled ?
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
